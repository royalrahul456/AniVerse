...
async def cb_dm_help(callback: CallbackQuery):
    ...
    text = (
        ...
        "╭───「 🎒 Trainer Utilities 」───╮\n"
        "├─➩ <code>/profile</code> — Stats & themes\n"
        "├─➩ <code>/harem</code> — View harem collection\n"
        "├─➩ <code>/leaderboard [type]</code> — Global rankings (coins/catches)\n"
        "├─➩ <code>/check &lt;id&gt;</code> — Character status\n"
        "├─➩ <code>/search &lt;name&gt;</code> — Database lookup\n"
        "├─➩ <code>/anime &lt;show&gt;</code> — Filter by anime\n"
        "├─➩ <code>/fav &lt;id&gt;</code> — Custom harem banner\n"
        "├─➩ <code>/claim</code> — Free daily character\n"
        "╰───────────────────────────╯\n\n"
        "╭───「 🎮 Games & Arcade 」───╮\n"
        "├─➩ <code>/games</code> — Games Center menu\n"
        "├─➩ <code>/spin</code> — Lucky spin wheel\n"
        "├─➩ <code>/daily</code> — Claim daily bonus coins\n"
        "├─➩ <code>/coinflip &lt;bet&gt; &lt;choice&gt;</code>\n"
        "├─➩ <code>/dice &lt;bet&gt; &lt;choice&gt;</code>\n"
        "├─➩ <code>/trivia</code> — Play anime quizzes\n"
        "├─➩ <code>/mines &lt;bet&gt; &lt;mines&gt;</code>\n"
        "├─➩ <code>/scramble</code> — Word puzzle rewards\n"
        "├─➩ <code>/xo &lt;reply&gt;</code> — Play Tic-Tac-Toe\n"
        "╰───────────────────────────╯\n\n"
        "╭───「 🤝 Commerce & Deals 」───╮\n"
        "├─➩ <code>/shop</code> — Buy profile themes\n"
        "├─➩ <code>/trade &lt;your_id&gt; &lt;their_id&gt;</code>\n"
        "├─➩ <code>/redeem &lt;code&gt;</code> — Claim promo code\n"
        "├─➩ <code>/auction &lt;id&gt; &lt;price&gt;</code> — List character\n"
        "├─➩ <code>/bid &lt;auc_id&gt; &lt;amount&gt;</code> — Bid on active\n"
        "├─➩ <code>/cancelauction &lt;auc_id&gt;</code>\n"
        "├─➩ <code>/auctions</code> — View active/queue\n"
        "╰───────────────────────────╯\n\n"
        "📌 <i>Keep chatting in group chats to trigger wild character spawns, and type <code>/guess &lt;name&gt;</code> to collect them!</i>"
        + (f"\n\n👑 <b>Owner:</b> Since you are a bot owner, type <code>/ownerhelp</code> to see creator tools!" if is_admin else "")
    )
